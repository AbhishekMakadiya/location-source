...
class MyCustomCheckBox(context: Context, attrs: AttributeSet?) : AppCompatCheckBox(context, attrs) {
    //    private val TAG: String = this.javaClass.simpleName
    init {
//        val textStyle = attrs?.getAttributeIntValue(Const.ANDROID_SCHEMA, "textStyle", Typeface.NORMAL)

        val array = context.obtainStyledAttributes(attrs, R.styleable.MyCustomCheckBox)
