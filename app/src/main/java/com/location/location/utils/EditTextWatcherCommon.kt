...
class EditTextWatcherCommon constructor(@NonNull editText: EditText) {
    ...
    fun create(editText: EditText): EditTextWatcherCommon {
        return EditTextWatcherCommon(editText)
    }

    fun create(editText: EditText, delayMillis: Int): EditTextWatcherCommon {
        val editTextDebounce = EditTextWatcherCommon(editText)
