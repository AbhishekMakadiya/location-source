package com.lovebuzz.countrypicker;
...
import com.lovebuzz.countrypicker.listeners.BottomSheetInteractionListener;
import com.lovebuzz.countrypicker.listeners.OnCountryPickerListener;
import com.lovebuzz.countrypicker.listeners.OnItemClickListener;
...
public class CountryPicker implements BottomSheetInteractionListener, LifecycleObserver {
  ...
  private final Country[] COUNTRIES = {
      ...
      new Country("AG", "Antigua and Barbuda", "+1268", R.drawable.flag_ag, "XCD"),
      new Country("AI", "Anguilla", "+1264", R.drawable.flag_ai, "XCD"),
      ...
      new Country("AS", "American Samoa", "+1684", R.drawable.flag_as, "USD"),
      ...
      new Country("BB", "Barbados", "+1246", R.drawable.flag_bb, "BBD"),
      ...
      new Country("BM", "Bermuda", "+1441", R.drawable.flag_bm, "BMD"),
      ...
      new Country("BS", "Bahamas", "+1242", R.drawable.flag_bs, "BSD"),
      ...
      new Country("DM", "Dominica", "+1767", R.drawable.flag_dm, "XCD"),
      new Country("DO", "Dominican Republic", "+1849", R.drawable.flag_do, "DOP"),
      ...
      new Country("GD", "Grenada", "+1473", R.drawable.flag_gd, "XCD"),
      ...
      new Country("GU", "Guam", "+1671", R.drawable.flag_gu, "USD"),
      ...
      new Country("JM", "Jamaica", "+1876", R.drawable.flag_jm, "JMD"),
      ...
      new Country("KN", "Saint Kitts and Nevis", "+1869", R.drawable.flag_kn, "XCD"),
      ...
      new Country("KY", "Cayman Islands", "+1345", R.drawable.flag_ky, "KYD"),
      ...
      new Country("LC", "Saint Lucia", "+1758", R.drawable.flag_lc, "XCD"),
      ...
      new Country("MP", "Northern Mariana Islands", "+1670", R.drawable.flag_mp, "USD"),
      new Country("MR", "Mauritania", "+222", R.drawable.flag_mr, "MRO"),
      new Country("MS", "Montserrat", "+1664", R.drawable.flag_ms, "XCD"),
      ...
      new Country("PR", "Puerto Rico", "+1939", R.drawable.flag_pr, "USD"),
      ...
      new Country("SX", "Sint Maarten", "+1721", R.drawable.flag_sx, "ANG"),
      new Country("SY", "Syria", "+963", R.drawable.flag_sy, "SYP"),
      new Country("SZ", "Swaziland", "+268", R.drawable.flag_sz, "SZL"),
      new Country("TC", "Turks and Caicos Islands", "+1649", R.drawable.flag_tc, "USD"),
      ...
      new Country("VC", "Saint Vincent and the Grenadines", "+1784", R.drawable.flag_vc, "XCD"),
      new Country("VE", "Venezuela", "+58", R.drawable.flag_ve, "VEF"),
      new Country("VG", "British Virgin Islands", "+1284", R.drawable.flag_vg, "USD"),
      new Country("VI", "U.S. Virgin Islands", "+1340", R.drawable.flag_vi, "USD"),
