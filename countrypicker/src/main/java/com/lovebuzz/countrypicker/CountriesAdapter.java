...
public class CountriesAdapter extends
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    ...
    holder.countryDialCodeText.setText(country.getDialCode());
    holder.countryDialCodeText.setTextColor(textColor == 0 ? Color.BLACK : textColor);
  ...
  class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private TextView countryDialCodeText;
    ...
    ViewHolder(View itemView) {
      ...
      countryDialCodeText = itemView.findViewById(R.id.countryDialCode);
